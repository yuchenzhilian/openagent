...
class QuantizationBenchmark {
  ...
  void addPresets() { _configs.addAll([const QuantConfig(visionBits: QuantBits.int8, languageBits: QuantBits.fp16), const QuantConfig(visionBits: QuantBits.int4, languageBits: QuantBits.int8), const QuantConfig(visionBits: QuantBits.int3, languageBits: QuantBits.int4), const QuantConfig(visionBits: QuantBits.int4, languageBits: QuantBits.int4)]); }

  QuantConfig? bestConfig({double accuracyWeight = 0.4, double speedWeight = 0.3, double memoryWeight = 0.3}) => _configs.isEmpty ? null : _configs.first;
