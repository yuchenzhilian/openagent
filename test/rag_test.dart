...
void main() {
  ...
  group('KnowledgeCache', () {
    test('addHot', () async { final c = KnowledgeCache(cacheDir: '/tmp'); await c.initialize(); c.addHot(const CachedDoc(docId: 'd1', fileName: 't.txt', sizeBytes: 100, lastAccessed: null, isHot: true)); expect(c.stats()['hot'], 1); await c.clear(); });
  });
}